...
docker run --rm -it -v `pwd`:/project:rw -w /project -u $(id -u ${USER}):$(id -g ${USER}) --network none runify_protoc_gen_dart:${IMAGE_VERSION} protoc --dart_out=./ui/lib ./proto/runify.proto
