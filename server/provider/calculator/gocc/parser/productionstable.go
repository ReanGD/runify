...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `Expr0Lvl : Expr0Lvl "+" Expr1Lvl	<< ast.BinaryExpr(X[0], X[2], '+') >>`,
		Id:         "Expr0Lvl",
		NTType:     2,
		Index:      2,
		NumSymbols: 3,
		ReduceFunc: func(X []Attrib, C interface{}) (Attrib, error) {
			return ast.BinaryExpr(X[0], X[2], '+')
		},
	},
	ProdTabEntry{
		String: `Expr0Lvl : Expr0Lvl "-" Expr1Lvl	<< ast.BinaryExpr(X[0], X[2], '-') >>`,
	...
	ProdTabEntry{
		String: `Expr1Lvl : Expr1Lvl "*" Expr2Lvl	<< ast.BinaryExpr(X[0], X[2], '*') >>`,
		Id:         "Expr1Lvl",
		NTType:     3,
		Index:      5,
		NumSymbols: 3,
	...
	ProdTabEntry{
		String: `Expr2Lvl : "+" Expr2Lvl	<< ast.UnaryExpr(X[1], '+') >>`,
		Id:         "Expr2Lvl",
		NTType:     4,
		Index:      8,
		NumSymbols: 2,
		ReduceFunc: func(X []Attrib, C interface{}) (Attrib, error) {
			return ast.UnaryExpr(X[1], '+')
		},
	},
	ProdTabEntry{
		String: `Expr2Lvl : "-" Expr2Lvl	<< ast.UnaryExpr(X[1], '-') >>`,
	...
	ProdTabEntry{
		String: `Expr3Lvl : Expr3Lvl "^" Number	<< ast.BinaryExpr(X[0], X[2], '^') >>`,
		Id:         "Expr3Lvl",
		NTType:     5,
		Index:      11,
		NumSymbols: 3,
